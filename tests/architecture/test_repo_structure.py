...
EXPECTED_FILES = [
    ...
    "src/aqcs/backtesting/engine.py",
    "src/aqcs/backtesting/models.py",
    "src/aqcs/backtesting/execution.py",
    "src/aqcs/backtesting/metrics.py",
    "src/aqcs/backtesting/validation.py",
